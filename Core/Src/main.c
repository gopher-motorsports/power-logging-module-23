...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : EN_12V_6_Pin EN_12V_5_Pin EN_12V_4_Pin */
  GPIO_InitStruct.Pin = EN_12V_6_Pin|EN_12V_5_Pin|EN_12V_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/**
  * @brief  Function implementing the PLM_StoreData thread.
...
/**
* @brief Function implementing the PLM_ServiceCAN thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the PLM_TransmitDat thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the PLM_SimulateDat thread.
* @param argument: Not used
* @retval None
*/
